const omikujiConfig = {
    ...
    "イヌ": {
        animalImg: '/pages/images/animals/inu.png',
        aboutTemplate: [
    ...
    "カバ": {
        animalImg: '/pages/images/animals/kaba.png',
        aboutTemplate: [
    ...
    "コアラ": {
        animalImg: '/pages/images/animals/koara.png',
        aboutTemplate: [
    ...
    "クマ": {
        animalImg: '/pages/images/animals/kuma.png',
        aboutTemplate: [
    ...
    "パンダ": {
        animalImg: '/pages/images/animals/panda.png',
        aboutTemplate: [
    ...
    "ペンギン": {
        animalImg: '/pages/images/animals/pengin.png',
        aboutTemplate: [
    ...
    "ライオン": {
        animalImg: '/pages/images/animals/raion.png',
        aboutTemplate: [
    ...
    "リス": {
        animalImg: '/pages/images/animals/risu.png',
        aboutTemplate: [
